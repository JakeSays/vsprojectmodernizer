...
namespace Std.Tools.Projects
{
    public static class SystemNuGetPackages
    {
        ...
        private static readonly (string name, string version)[] Packages461 = { ("System.IO.IsolatedStorage", "4.*") };
            ...
            DetectUpgradeableReferences(Project project)
        {
            ...
            if (hasFramework && string.Compare(minTargetFramework, "net46", comparison) >= 0 ||
            ...
            if (hasFramework && string.Compare(minTargetFramework, "net461", comparison) >= 0 ||
            ...
            void ReportForVersion(ICollection<(string name, string version)> packages)
            {
                ...
                foreach (var assembly in matchingAssemblyRefs)
                {
                    ...
                    list.Add((name, version, correctCaseDefinition));
                }
            }
        }
    }
